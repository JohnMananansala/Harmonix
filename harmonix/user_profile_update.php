...
// $user_role = get_user_type($user_type);
// echo "User Type: " . $user_type;

if (isset($_POST['become_seller'])) {

   $update_profile = $conn->prepare("UPDATE `users` SET user_type = 'seller' WHERE id = $user_id");
   ...
   // Update the user's role in the database to "Seller"
   $query = "UPDATE users SET user_type = 'Seller' WHERE id = :user_id";
   ...
   if ($stmt->execute()) {
       ...
       $message[] = "Error: Unable to become a seller.";
   }
}
